...
#define POLYBENCH_ALLOC_1D_ARRAY(n1, type)                             \
	(type(*)[n1 + POLYBENCH_PADDING_FACTOR]) polybench_alloc_data( \
		n1 + POLYBENCH_PADDING_FACTOR, sizeof(type))
...
#define POLYBENCH_2D_ARRAY_DECL(var, type, dim1, dim2, ddim1, ddim2)      \
	type POLYBENCH_2D_F(POLYBENCH_DECL_VAR(var), dim1, dim2, ddim1,   \
			    ddim2);                                       \
...
#define POLYBENCH_5D_ARRAY_DECL(var, type, dim1, dim2, dim3, dim4, dim5,     \
	...
	type POLYBENCH_5D_F(POLYBENCH_DECL_VAR(var), dim1, dim2, dim3, dim4, \
